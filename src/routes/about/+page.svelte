...
<div class="px-8 pt-8 pb-8">
	...
	<!-- Introduction -->
	<div class="mt-8">
		<h2 class="mb-4 text-xl font-semibold text-blue-600">Profil</h2>
		<div class="space-y-3 text-gray-700">
			<p>
				Développeur Front-End depuis 2011, j'accompagne les entreprises en freelance pour concevoir
				et optimiser des interfaces web modernes, performantes et accessibles.
			</p>
			<p>
				J'intègre des applications en HTML/CSS dans le respect des bonnes pratiques d'accessibilité
				et je possède également de l'expérience en Design System et Design Tokens, permettant de
				garantir la cohérence visuelle et technique des interfaces.
			</p>
			<p>
				...
				d'automatisation, j'intègre des stratégies de tests unitaires pour assurer la robustesse et
	...
	<!-- Skills -->
	<div class="mt-10">
		<h2 class="mb-6 text-xl font-semibold text-blue-600">Compétences</h2>
	...
	<div class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
		<!-- Education -->
		<div>
			<h2 class="mb-4 text-xl font-semibold text-blue-600">Formation</h2>
			<div class="space-y-3">
		...
		<!-- Languages -->
		<div>
			<h2 class="mb-4 text-xl font-semibold text-blue-600">Langues</h2>
			<div class="space-y-3">
