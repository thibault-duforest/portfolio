...
<div class="container mx-auto px-4 py-8" in:fade={{ duration: 300 }}>
	...
	<div class="overflow-hidden rounded-lg bg-white shadow-lg" in:fly={{ y: 50, duration: 400 }}>
		<div class="h-80 overflow-hidden">
			<img src={data.project.image} alt={data.project.name} class="h-full w-full object-cover" />
		</div>
		...
		<div class="p-8">
			...
			<div class="mb-8">
				<h2 class="mb-4 text-xl font-semibold">Fonctionnalités</h2>
